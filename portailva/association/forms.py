...
class AssociationNewForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        super(AssociationNewForm, self).__init__(*args, **kwargs)
        self.helper = FormHelper()
        self.helper.form_method = 'post'
        self.helper.form_id = 'newForm'
...
class AssociationAdminUpdateForm(AssociationUpdateForm):
    is_active = forms.BooleanField(
        label="Association active ?",
        required=False
    )
